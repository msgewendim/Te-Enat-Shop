      ...
      <div className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <nav aria-label={t('footer.brand')}>
            <Link href="/" className="text-xl mb-4 font-semibold hover:text-gray-600 focus:outline-none focus:text-gray-600 dark:text-gray-50 dark:hover:text-gray-400" aria-label={t('footer.brand')}>
              {t('footer.brand')}
            </Link>
